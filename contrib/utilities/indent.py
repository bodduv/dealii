...
#
# Usage:     python contrib/utilities/indent.py
#
...
def check_clang_format_version(args, compatible_version_list=['6.0.0','6.0.1']):
  """
...
if __name__ == "__main__":
  ...
  if not args.clang_format_binary:
    os.environ["PATH"] += ':' + os.getcwd() + "/contrib/utilities/programs/clang-6/bin"
  ...
  check_clang_format_version(args, ['6.0.0', '6.0.1'])
  process(args)
  finish = time.time()
